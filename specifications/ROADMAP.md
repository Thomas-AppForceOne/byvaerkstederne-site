...
### 7. CI release protection, Part 1: PR validation & merge guards — Planned

**Spec:** [ci_release_protection_part1_specification.md](ci_release_protection_part1_specification.md)
