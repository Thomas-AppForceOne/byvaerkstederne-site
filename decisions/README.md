...
| [ADR-007](ADR-007-feature-flag-fallback-fails-closed.md) | The local all-on profile is never deployed, so a tier has no feature-flag fallback | Accepted | 2026-08-16 |
