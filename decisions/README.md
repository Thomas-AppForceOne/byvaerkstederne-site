...
| [ADR-007](ADR-007-feature-flag-fallback-fails-closed.md) | The feature-flag fallback fails closed; the developer's all-on profile lives under `localhost` | Accepted | 2026-08-16 |
